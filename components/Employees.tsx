...
export default function Employees(){
    ...
    return (
        <div className="flex flex-col gap-10 p-10 w-full items-center justify-center">
            <div className="text-center">
                <h1 className="text-5xl font-extrabold">Our Employees</h1>
            </div>
            <div className="grid grid-cols-3 gap-10">
                <div className="flex items-center justify-center border p-10 rounded-4xl border-indigo-500 shadow-lg">
                    <Image alt="gender-identity" src={gender}/>
                    <h1 className="text-lg font-bold tracking-tight p-2 ml-2">Gender Identity</h1>
                </div>
                <div className="flex items-center justify-center border p-10 rounded-4xl border-indigo-500 shadow-lg">
