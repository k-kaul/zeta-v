...
export function CardDemo() {
  return (
    <div className="">
      <div
        className={cn(
          "group w-96 cursor-pointer overflow-hidden relative card h-96 rounded-md shadow-xl mx-auto flex flex-col justify-end p-4 border border-transparent dark:border-neutral-800",
